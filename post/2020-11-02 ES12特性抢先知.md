...
![1_TK3lUqXrmh82x3Mjb3Oa0A.png](https://cdn.nlark.com/yuque/0/2020/png/705365/1604246060520-ee2e2786-fea1-4284-b1f6-eeafad723ff7.png#align=left&display=inline&height=412&margin=%5Bobject%20Object%5D&name=1_TK3lUqXrmh82x3Mjb3Oa0A.png&originHeight=412&originWidth=680&size=210487&status=done&style=none&width=680)
...
## replaceAll
看到**replaceAll这个词**，相比很容易联想到replace。在JavaScript中，replace方法只能是替换字符串中匹配到的第一个实例字符，而不能进行全局多项匹配替换，唯一的办法是通过正则表达式进行相关规则匹配替换
